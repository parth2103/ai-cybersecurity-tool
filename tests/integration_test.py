...
class IntegrationTests(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            if response.status_code != 200:
                raise unittest.SkipTest("API server is not running. Start with: python api/app.py")
    ...
    def test_single_prediction_normal(self):
        ...
        self.assertLess(data['threat_score'], 0.5, 
    ...
    def test_model_loading(self):
        ...
        self.assertGreater(len(data['models_loaded']), 0, 
                          "No models are loaded")
        self.assertIn('rf', data['models_loaded'], 
    ...
    def test_threat_level_classification(self):
        ...
        for expected_score, expected_level in test_cases:
            ...
            self.assertIn(data['threat_level'], 
